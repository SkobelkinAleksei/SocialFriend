...
public class OutboxRelay {
    ...
    private static final Set<String> ALLOWED_TYPES = Set.of(
            EventCreatedEvent.class.getName(),
            EventUserJoinedEvent.class.getName(),
            EventUserLeftEvent.class.getName(),
            UserReputationChangedEvent.class.getName()
    );

    private static final Map<String, Class<?>> TYPE_BY_NAME = Map.of(
            EventCreatedEvent.class.getName(), EventCreatedEvent.class,
            EventUserJoinedEvent.class.getName(), EventUserJoinedEvent.class,
            EventUserLeftEvent.class.getName(), EventUserLeftEvent.class,
            UserReputationChangedEvent.class.getName(), UserReputationChangedEvent.class
    );
